...
class Client implements ClientInterface
{
    ...
    /** @var string[] The sub-Products helpers classes */
    protected static $subProductClasses = [
        'crm' => Crm\SubProduct::class,
        // 'desk' => Desk\SubProduct::class,
    ];
    ...
    /** @var AbstractSubApi[] The sub-Products helpers */
    ...
    public function __construct(
        ...
        $this->accessTokenStore = $accessTokenStore ?? new Core\AccessTokenStores\NoStore();
    ...
    /**
     * Attach all sub-Products helpers.
     *
     * @return void
     */
    protected function attachSubProducts(): void
    {
        foreach (static::$subProductClasses as $name => $class) {
            $this->subProducts[$name] = new $class($this);
        }
    }
     ...
     * @return AbstractSubApi
     */
    public function getSubApi(string $name): AbstractSubProduct
    {
        return $this->subProducts[$name];
    }
